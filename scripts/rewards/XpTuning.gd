...
# -----------------------
# NEW: Skill XP (on victory – per ability)
# -----------------------
# We award at encounter end, proportional to how many times the ability was used.
# Multipliers: elite +30%, boss +50% (as you requested). No diminishing returns by spam; only overlevel diminishes.
# This is intentionally simple and independent of damage dealt.
